# Modifique as funções que foram criaa no desafio 107 para que eles aceitem um parametro a mais, informando se o valor retornado por elas vai ser ou não formatado pela função moeda(), desenvolvida no desafio 108.
